    ...
    <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="section-title">About Apex Van Hire</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16">
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 mb-4">
              Apex Van Hire was founded in 2018 with a simple mission: to provide reliable, affordable van rental solutions for businesses and individuals in Cape Town and beyond.
            </p>
            <p className="text-gray-700 mb-4">
              What started with a modest fleet of just 5 vans has grown into one of the region's most trusted vehicle rental services, now operating over 50 vehicles of various sizes to meet any transportation need.
            </p>
            <p className="text-gray-700">
              Our founder, Johan van der Merwe, identified a gap in the market for quality van rentals with exceptional customer service, and this vision continues to drive our business today. We've built our reputation on reliability, transparency, and going the extra mile for our customers.
            </p>
          </div>

          <div className="md:w-1/2">
            <img 
              src="https://images.unsplash.com/photo-1570129477492-45c003edd2be?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80" 
        ...
        <div className="bg-primary-blue text-white rounded-lg p-8 text-center">
          <h3 className="text-2xl font-bold mb-4">Join the Apex Family</h3>

    ...
    <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="section-title text-primary-maroon">About McKenna's Rental And Transport</h2>
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-16">
          <div className="md:w-1/2">
            <h3 className="text-2xl font-bold mb-4 text-accent-maroon">Our Story</h3>
        ...
        <h3 className="text-2xl font-bold mb-6 text-center text-primary-maroon">Our Values</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {values.map((value, index) => (
            <div key={index} className="bg-gray-50 rounded-lg p-6 text-center shadow-md">
              <div className="bg-opacity-10 p-4 rounded-full w-16 h-16 flex items-center justify-center mb-4 mx-auto bg-accent-maroon">
                <value.icon className="w-8 h-8 text-accent-maroon" />
              </div>
              <h4 className="text-lg font-semibold mb-3 text-primary-maroon">{value.title}</h4>
              <p className="text-gray-600 text-sm">{value.description}</p>
            </div>
          ))}
        </div>

        <div className="text-white p-8 text-center bg-accent-maroon rounded-full">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="#fleet" className="bg-white text-primary-maroon hover:bg-gray-100 font-semibold py-2 px-6 rounded-md transition-colors">
              Explore Our Fleet
            </a>

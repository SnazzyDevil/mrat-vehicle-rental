...
const vans = [
  ...
  },
  {
    ...
    category: 'pickup',
    specs: {
      loadSpace: '2.2 cubic meters',
      maxLoad: '550kg',
      dimensions: '4.2m x 1.7m x 1.8m',
      fuelType: 'Petrol',
      transmission: 'Manual'
    }
  },
  {
    id: 5,
    name: 'Isuzu NPR Refrigerated Truck',
  ...
  },
  {
    ...
    category: 'pickup',
    specs: {
      loadSpace: '2.9 cubic meters',
      maxLoad: '750kg',
      dimensions: '5.3m x 1.8m x 1.9m',
      fuelType: 'Diesel',
      transmission: 'Manual'
    }
  }

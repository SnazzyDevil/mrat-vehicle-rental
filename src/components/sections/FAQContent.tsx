  ...
  return <section className="section-padding bg-white">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="section-title font-normal text-[#601112]">Frequently Asked Questions</h2>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a href="tel:+27783102618" className="flex items-center gap-2 border border-primary-blue text-primary-blue hover:bg-primary-blue hover:bg-opacity-5 font-semibold py-2 px-6 rounded-md transition-colors">

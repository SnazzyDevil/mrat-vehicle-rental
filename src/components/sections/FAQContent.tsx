              ...
              >
                ...
                >
                  ...
                  {activeIndex === index ? (
                    ...
                    <ChevronDown className="h-5 w-5 text-primary-blue" />
                  )}
                </button>
                {activeIndex === index && (
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              ...
              <a
                ...
                className="flex items-center gap-2 border border-primary-blue text-primary-blue hover:bg-primary-blue hover:bg-opacity-5 font-semibold py-2 px-6 rounded-md transition-colors"
              >

  ...
  return (
    <section className="section-padding bg-gray-50">
      <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary-blue"
        ...
        <div className="mt-12">
          <h3 className="text-xl font-bold text-primary-blue mb-6 text-center">Our Location</h3>
          <div className="aspect-w-16 aspect-h-9 rounded-lg overflow-hidden shadow-lg">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13251.641228052232!2d18.41391674999999!3d-33.92473295!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1dcc676354efda3b%3A0x9c89f219e47e5031!2sCape%20Town%20City%20Centre%2C%20Cape%20Town%2C%20South%20Africa!5e0!3m2!1sen!2sus!4v1650394321001!5m2!1sen!2sus"
              width="100%"
              height="450"
              style={{border: 0}}
              allowFullScreen

    ...
    <section className="section-padding bg-gradient-to-r from-gray-900 to-primary-blue">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Book Your Van</h2>
        ...
        <div className="mt-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <a 
              ...
              className="flex items-center gap-2 bg-white text-primary-blue hover:bg-gray-100 font-semibold py-2 px-6 rounded-md transition-colors"
            >
            ...
            <a 
              href="#contact" 
              className="flex items-center gap-2 border border-white text-white hover:bg-white hover:bg-opacity-10 font-semibold py-2 px-6 rounded-md transition-colors"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

...
const testimonials = [{
  ...
  image: '',
  rating: 5,
  text: 'MRAT vehicle rental provided excellent service for our company\'s delivery needs. The vans were in great condition and the staff was extremely helpful. Will definitely use their services again!',
  type: 'business'
}, {
  id: 2,
  name: 'Sarah Johnson',
  ...
  image: '',
  rating: 5,
  text: 'I used MRAT vehicle rental for my house move and was very impressed. The booking process was simple, the van was clean and well-maintained, and the pricing was very reasonable. Highly recommend!',
  type: 'personal'
}, {
  id: 3,
  name: 'Michael Brown',
  ...
  image: '',
  rating: 4,
  text: 'We\'ve been using MRAT Vehicle Rental for our distribution needs for over a year now. Their fleet is reliable and their customer service is top-notch. A great partner for our business.',
  type: 'business'
}, {
  id: 4,
  name: 'Emily Wilson',
      ...
      <div className="container mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg opacity-90 max-w-3xl mx-auto mb-8">
            Don't just take our word for it. Here's what some of our satisfied customers have to say about their experience with MRAT vehicle rental.
          </p>
